...
export const copy = {
  en: {
    ...
    chapters: [
      ...
      { label: 'WORDS BECOME WORK', title: 'Say it once.\nYour AI does the rest.', description: 'Ask, and the Agent picks it up. It reads your data, fills the form and sends it for approval — all in one conversation.', name: 'Just Ask' },
      { label: 'MEET YOUR TEAM', title: 'Switch on AI for every team.', description: 'HR, finance and sales each bring their own expertise to one shared platform.', name: 'AI Agents' },
    ...
    features: [
      { title: 'Build and dispatch', body: 'Guided setup per Agent: persona, knowledge, skills, channels. The supervisor routes every task.' },
      { title: 'Cost governance', body: 'Each Agent has its own billing key. Usage traces to a single chat; the cap stops it.' },
      { title: 'Guardrails', body: 'PII masking and keyword blocking, enforced at the model gateway and logged.' },
      { title: 'Every channel', body: 'One click to Discord, LINE or web. People ask where they already work, under one identity.' },
      { title: 'Knowledge and access', body: 'Mount local files or Google Drive; the AI sorts them. Access runs through a controlled channel.' },
      { title: 'Self-improvement', body: 'Agents read their usage and propose fixes — each reviewed by a person, and reversible.' },
    ],
    agents: [
    ...
    task: {
      ...
      user: 'I\u2019d like Wednesday and Thursday off next week, with Ming covering.',
      replies: ['Sending your task…', 'Got it — checking your balance and cover…', 'Your request is ready. Confirm and I\u2019ll send it to your manager.'],
